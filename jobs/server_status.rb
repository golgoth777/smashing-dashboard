...
servers = [{name: 'gogs', url: 'http://git.nicolleau.eu', method: 'http'},
		{name: 'homepage', url: 'https://ks3277700.kimsufi.com', method: 'http'},
		{name: 'freebox', url: 'local.nicolleau.eu', method: 'ping'}]
